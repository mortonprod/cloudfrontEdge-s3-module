...
exports.originResponse = (event, context, callback) => {
    ...
    headers["content-security-policy"] = [{
        ...
        value: "default-src 'self'; connect-src 'self' ses.alexandermorton.co.uk; script-src 'self' code.getmdl.io code.jquery.com; style-src 'self' code.getmdl.io fonts.googleapis.com; font-src 'self' code.getmdl.io fonts.googleapis.com fonts.gstatic.com",
    }];
